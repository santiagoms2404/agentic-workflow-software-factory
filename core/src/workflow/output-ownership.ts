import type { ArtifactKind, EnvelopeBase } from "../contracts/envelope-base.ts";
...
export const PHASE_OUTPUT_OWNERSHIP = Object.freeze({
  ...
  planner: { outputs: ["plan"], artifactKinds: ["plan"] },
  plan: { outputs: ["plan"], artifactKinds: ["plan"] },
  ...
  reviewer: { outputs: ["review"], artifactKinds: [] },
  "design-context": { outputs: ["plan"], artifactKinds: [] },
  design: { outputs: ["plan"], artifactKinds: ["plan"] },
  "architecture-review": { outputs: ["review"], artifactKinds: [] },
  "plan-context": { outputs: ["plan"], artifactKinds: [] },
  "plan-render": { outputs: ["plan", "documentation"], artifactKinds: ["plan", "documentation"] },
  scout: { outputs: ["review"], artifactKinds: [] },
