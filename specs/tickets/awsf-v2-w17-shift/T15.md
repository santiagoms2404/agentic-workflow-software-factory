---
id: T15
title: "The candidate is built fresh, and the preview follows delivery"
milestone: M5
state: todo
depends_on: [T14]
serves: [AC-6, INV-2, INV-3]
---
# T15 · The candidate is built fresh, and the preview follows delivery

> **Deep plan:** [`../../awsf-v2-w17-shift.html`](../../awsf-v2-w17-shift.html) § Implementation Phases → milestone M5 → task 15  
...
> **Serves:** AC-6, INV-2, INV-3 (declared in the plan's Identifier Spine)
