---
id: T13
title: "Testing strategy for M4 - failure, durability, and the ref"
milestone: M4
state: todo
depends_on: [T11, T12]
serves: [AC-4, AC-5]
...
> **Deep plan:** [`../../awsf-v2-w17-shift.html`](../../awsf-v2-w17-shift.html) § Implementation Phases → milestone M4 → task 13  
...
> **Serves:** AC-4, AC-5 (declared in the plan's Identifier Spine)

## What this ticket is

A **testing and milestone-closing** task. It closes milestone M4: it flips that milestone's header and every remaining box in it, and records the milestone-closing Amendment in this plan. It does **not** touch the spine.
