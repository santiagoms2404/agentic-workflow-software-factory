...
- [ ] **Spawn is legal on exactly five edges** (L4, L10, L11, L16, L19); every other pair attempting a spawn raises `IllegalSpawnSite`. — `unit` + `sim` (broker-level assertion in M3).
