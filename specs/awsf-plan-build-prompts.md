...
DO: drive `awsf new … && awsf start …` for the owner's task via build or
plan-build-test · watch on the dashboard · owner lands via TTY · write
records/pilots/pilot-1.md: task, route, calls by category, tokens, duration, gates,
outcome — concise, no receipt sprawl.
