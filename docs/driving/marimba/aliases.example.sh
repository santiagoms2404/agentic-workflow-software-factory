...
alias marimba-pi-sol-low="_marimba_pi --model gpt-5.6-sol   --thinking low"
...
alias marimba-pi-luna-xhigh="_marimba_pi --model gpt-5.6-luna  --thinking xhigh"
alias marimba-pi-luna-high="_marimba_pi --model gpt-5.6-luna  --thinking high"
alias marimba-pi-luna-medium="_marimba_pi --model gpt-5.6-luna  --thinking medium"
