...
`journey`, `land`, `cancel`, `rework`, `review`, `raise` and `publish` are owner acts.
...
| the owner is weighing `journey`, `land`, `cancel`, `rework`, `review`, `raise` or `publish` | `cookbooks/owner_acts.md` |
